...
## Explicado
- **Addressable**: No hay error, son espacios en memoria disponibles.
...
- **Heap left redzone**: Espacio en memoria malloqueado que no has liberado.
- **Freed heap region**: Espacio en memoria malloqueado y liberado, no deberias intentar acceder a el.
## Fuentes
